...
@endif
    ...
    <section class="content">
        ...
        <form action="{{route('trainingSession.update_session',[$trainingSession['id']])}}" method="post" enctype="multipart/form-data" class="w-75 m-auto">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-12">
                    <a href="{{ route('trainingSession.listSessions')}}" class="btn btn-secondary">Cancel</a>
